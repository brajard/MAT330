...
\begin{frame}{Overview of the next lectures}
    \begin{enumerate}
        \item Lecture 1 (Thursday 14 Oct.): Generalities and  principles of Machine Learning
        \item Lecture 2 (Tuesday 19 Oct.): Machine learning process, neural networks, deep learning
        \item Lecture 3 (Thursday 21 Oct.): How to train a machine learning algorithm?
        \item Practical Work (Tuesday 26 Oct.): Emulate a dynamical model using machine learning
