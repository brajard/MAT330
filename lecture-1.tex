...
\begin{frame}{Overview of the next lectures}
    \begin{enumerate}
        \item Lecture 1 (Thursday 06 Oct.): Generalities and  principles of Machine Learning
        \item Lecture 2 (Thursday 20 Oct.): Neural networks, deep learning, training
        \item Lecture 3 (Thursday 20 Oct.): Practical work
...
\begin{frame}{References}
    ...
    \nocite{chollet2021deep,VanderPlas-2016}
...
\pause
    \begin{figure}
        \centering
        \includegraphics[width=0.9\textwidth]{fig/L1/text2image.png}
...
\begin{frame}
\frametitle{Limits?}
A test on: \url{https://deepai.org/machine-learning-model/text2img}\\
\vspace{1em}
Text: \emph{``students attending a machine learning course''}
    \pause
    \begin{figure}
        \centering
        \includegraphics[width=0.5\textwidth]{fig/L1/person_text2image.jpeg}
...
{\bf 2018}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{fig/L3/478px-Edmond_de_Belamy.png}
        \caption*{\footnotesize \textit{Edmond de Bellamy} by Obvious(collective)}
    \end{figure}
        \begin{footnotesize}
...
{\bf 2022}
    \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{fig/L1/theatre_opera.png}
        \caption*{\footnotesize \textit{Theatre D'opera Spatial} by Jason M. Allen}
    \end{figure}
    \begin{footnotesize}
    Generated using diffusion models.\\
    Won Colorado Sate Fair'a annual art competition (Sept. 2022)    
    \end{footnotesize}
...
\begin{frame}[fragile]{Questions addressed in this lecture}
    \begin{itemize}
        \item What are the more common area of application of machine learning? \cite[1]{chollet2021deep}
